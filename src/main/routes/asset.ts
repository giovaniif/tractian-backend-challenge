...
import { makeCreateAssetController, makeLoadAssetsByUnitController, makeDeleteAssetController, makeReadAssetController } from '@/main/factories/controllers/asset'
